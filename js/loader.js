...
// Guard gegen doppeltes Laden. Vorher wurde hier ein Error geworfen um den
// Rest der Datei abzubrechen — das ist unnötig laut, weil "schon geladen"
// kein echter Fehlerfall ist und in der Konsole als unhandled error auftaucht.
// window._loaderReady steuert stattdessen weiter unten, ob der eigentliche
// Setup-Code (DOMContentLoaded-Listener etc.) überhaupt registriert wird.
if (window._loaderLoaded) {
  console.warn("loader.js wurde doppelt geladen – abgebrochen");
}
window._loaderReady = !window._loaderLoaded;
