...
// Empfangen der Feedback-Nachricht und des Namens über die URL
$feedbackMessage = isset($_GET['message']) ? $_GET['message'] : "Keine Nachricht erhalten.";
$name = isset($_GET['name']) ? htmlspecialchars($_GET['name']) : "Unbekannter Benutzer";
?>

<!DOCTYPE html>
<html lang="de">
<head>
  <meta charset="UTF-8"> <!--damit die zeichen öäüß richitg angeziegt werden-->
  ...
  <link rel="stylesheet" href="../css/feedback.css"/> <!-- verlinkung mit css datei-->
</head>
  <body>
  ...
  <main>
    ...
    <div class="feedback-message"> 
        <p>Danke für die Meldung, <?php echo $name; ?>!</p>
    </div>
    <div class="container">
        <a href="../index.html" class="back">Zurück zum Portfolio</a>
    ...
    <div style="height: 50px;"> <!-- Platzhalter --> </div>
      ...
      <div>
        <button id="transformStartButton" class="start">start</button>
      </div>
