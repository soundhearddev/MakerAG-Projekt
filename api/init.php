...
// WICHTIG: Vorher wurde JEDER Origin reflektiert UND gleichzeitig Credentials erlaubt —
// das erlaubt praktisch jeder Fremdseite, mit Cookies/Auth im Namen des Nutzers auf die
// API zuzugreifen (CSRF/CORS-Lücke). Deshalb jetzt eine explizite Whitelist.
// TODO: Domains an die eigene Produktiv-/Dev-URL anpassen.
$_allowedOrigins = [
    'http://localhost',
    'http://localhost:8080',
    'http://127.0.0.1:8080',
    // 'https://maker-ag.example',
];
if (isset($_SERVER['HTTP_ORIGIN']) && in_array($_SERVER['HTTP_ORIGIN'], $_allowedOrigins, true)) {
